...
<html lang="en">
  ...
  <section class="content" id="content">
                ...
                <table  border="3" cellspacing="0" class = "table ms-4">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>Rp. <?php echo number_format($row['qty'] * $row['product_price'] + $o->order_id)?></td>
      ...
      <div class="img_bukti m-5" >
      <a class="d-pesanan pt-2 ">Bukti Pembanyaran</a><br>
      <img src="payment/<?php echo $p['payment_proof'] ?>" class="" width="100px">
      </div>
