      ...
      <div class="container">
        <div class="row text-center">
          ...
          <div class="box">
            ...
            <div class="col-4">
              <img src="produk/<?php echo $p['product_image']?>" alt="tidak tersedia">
              <a class='nama d-flex justify-content-start mt-3'><?php echo $p['product_name']?></a>
              <a class='harga d-flex justify-content-end mb-3'>Rp. <?php echo number_format($p['product_price'])?></a>
              <div class="tambahkeranjang d-flex justify-content-center">
