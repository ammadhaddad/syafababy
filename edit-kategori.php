  ...
  <body>
   ...
   <header>
    ...
    <section class="profil" id="profil">
      <div class="container">
        <h3 class = "top d-flex justify-content-center">Edit Kategori</h3>
          <div class="row">
            <form action="" method="POST">
              <input type="text" name="nama" placeholder="Nama Kategori" class="input-field mb-4" value="<?php echo $k->category_name?>" required>
