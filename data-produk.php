...
<html lang="en">
  ...
  <body>
   ...
   <section class="data kategori" id="home">
        <div class="container">
        <h3 class = "top d-flex justify-content-center">Data Produk</h3>
            <div class="row">
                <p><a href="tambah-Produk.php" class="tambah-btn d-flex">Tambah Data</a></p>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <div class="icon-home justify-content-end">
                                <a href="edit-produk.php?id=<?php echo $row['product_id'] ?>"><i class='bx bxs-edit-alt' ></i></a> 
                                ||
                                <a href="proses-hapus.php?idp=<?php echo $row['product_id'] ?>" onclick="return confirm('Yakin ingin hapus ?')"><i class='bx bx-trash' ></i></a>
                            </div>
                            </td>
                        </tr>
                        <?php }}else{ ?>
