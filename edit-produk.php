...
<html lang="en">
  ...
  <body>
   ...
   <header>
    ...
    <div class="section">
      <div class="container">
        <h3 class = "top d-flex justify-content-center">Edit Produk</h3>
          <div class="row">
            <form action="" method="POST"enctype="multipart/form-data">
              ...
              <input type="text" name="nama" placeholder="Nama Produk" class="input-field" value="<?php echo $p->product_name?>"required>
              <input type="text" name="harga" placeholder="Harga" class="input-field" value="<?php echo $p->product_price?>" required>

              <img src ="produk/<?php echo $p->product_image?>" width="100px">
              <input type="hidden" name="foto" value="<?php echo $p->product_image?>" > 
              <input type="file" name="gambar" class="input-field">
              <textarea name="deskripsi" placeholder="Deskripsi" class="input-field"><?php echo $p->product_description?></textarea>
