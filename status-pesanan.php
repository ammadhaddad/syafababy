                ...
                <table  border="3" cellspacing="0" class = "table ms-4">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>Rp. <?php echo number_format($row['qty'] * $row['product_price']+ 15000 + $o->order_id)  ?></td>
                            
                        </tr>
                    </tbody>
                </table>
                <form action="" method="POST">
                  <a class="d-pesanan ms-5">Status Pesanan</a>
                    <select name="status" class="input-field ms-5">
